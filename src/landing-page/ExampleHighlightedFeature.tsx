...
export default function AIReady() {
  return (
    <HighlightedFeature
      name="Automation That Learns From Results"
      description="mAutomate.ai analyzes campaign performance and continuously improves targeting, timing, and messaging."
