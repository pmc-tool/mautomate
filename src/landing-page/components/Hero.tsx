...
import openSaasBannerDark from "../../client/static/mAutomation-hero-dark.jpg";
import openSaasBannerLight from "../../client/static/mAutomate-hero.jpeg";
        ...
        <div className="max-w-8xl mx-auto px-6 lg:px-8">
          <div className="lg:mb-18 mx-auto max-w-3xl text-center">
            <h1 className="text-foreground text-5xl font-bold sm:text-6xl">
              ...
              <span className="text-gradient-primary">mAutomate.ai</span>
            </h1>
            <p className="text-muted-foreground mx-auto mt-6 max-w-2xl text-lg leading-8">
              Launch and optimize multi-channel campaigns with AI workflows,
              audience segmentation, and real-time attribution.
            </p>
