...
async function handleOrderPaid(
  ...
  if (subscriptionPlanIds.includes(paymentPlanId)) {
    // Subscription order
    ...
    // Top-up order — handled via credit service in webhook handler
    console.log(
      `Top-up order received for plan ${paymentPlanId}, credits will be added via credit service.`,
    );
  }
}
